...
function Dashboard() {
  ...
  useEffect(() => {
    if (selectedQuery || deleteConfirm) {
                ...
                <div style={{ marginBottom: '32px' }}>
                  <div className="section-label">
                    ...
                    <button
                      ...
                      onClick={() => copyText(selectedQuery.raw_query, 'raw_query')}
                    >
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.optimized_query!, 'optimized_query')}
                      >
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.suggested_indexes!, 'suggested_indexes')}
                      >
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.bottleneck!, 'bottleneck')}
                      >
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.notes!, 'notes')}
                      >
                        {copiedField === 'notes' ? (
                          <>
                            <Check size={14} />
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.schema!, 'schema')}
                      >
                        {copiedField === 'schema' ? (
                          <>
                            <Check size={14} />
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    <div className="section-label">
                      ...
                      <button
                        ...
                        onClick={() => copyText(selectedQuery.execution_plan!, 'execution_plan')}
                      >
